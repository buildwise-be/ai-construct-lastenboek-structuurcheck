...
def main():
    ...
    if not any([vision_data, enhanced_data, direct_data]):
    ...
    # Compare formats
    analyses = compare_formats(vision_data, enhanced_data, direct_data)
    
    # Show sample outputs if requested
    if args.show_samples:
        show_sample_outputs(vision_data, enhanced_data, direct_data)
    ...
    print("SUMMARY")
    print("=" * 80)
    print("\nThe enhanced full content versions now output in the same format")
    print("as the vision-based summary approach, with additional fields for")
    print("deeper analysis. This provides:")
